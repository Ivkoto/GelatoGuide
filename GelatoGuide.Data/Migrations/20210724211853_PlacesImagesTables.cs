...
{
    public partial class PlacesImagesTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TakeawayLink = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FoodpandaLink = table.Column<string>(type: "nvarchar(max)", nullable: true),
